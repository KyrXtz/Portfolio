...
import { LandingPageId,AboutPageId, WorkPageId } from "utils/useScroll";
...
const Placeholder = lazy(() =>
    import("shared/page-header/PageHeader").then((module) => ({ default: module.Placeholder })),
);
